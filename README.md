...
research_optional/ 中另保留 MFT 210 题作为研究扩展材料，但不进入 V1.0 默认正式总览、覆盖门槛和通俗报告。
...
题库与指标口径.md — 正式题库范围和核心指标解释；

硅云部署说明.md — Ubuntu 云服务器部署教程；

V1.0冻结快照说明.md — 冻结范围和版本边界；

V1.0版本一致性审计报告.md — V1.0 审计与测试结果；

FREEZE_MANIFEST.json — 冻结快照机器可读清单；

VERSION.json — 产品及组件版本元数据。
